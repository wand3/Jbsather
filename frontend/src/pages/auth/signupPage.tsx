...
const SignupPage = () => {
  ...
  const handleEmailSignup = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      navigate('/hunt'); // Replace '/login' with the actual path to your login page
  ...
  const handleArtistLink = (e: React.MouseEvent<HTMLAnchorElement>) => {
    e.preventDefault();
    alert("Navigate to Jbsather Pro sign-up flow");
  };
